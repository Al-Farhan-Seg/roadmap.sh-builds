    ...
    <>
      ...
      <main className="flex min-h-screen items-center justify-center bg-white p-6 pt-24 font-sans">
        <div className="max-w-md text-center">
          <p className="text-sm font-medium text-emerald-700">Project 23 · React + Vite scaffold</p>
          <p className="mt-4 text-stone-600">The scaffold is ready. Build the repository finder here.</p>
        </div>
      </main>
    </>
  );
